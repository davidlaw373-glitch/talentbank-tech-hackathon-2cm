<<<<<<< Updated upstream
import { OfferOverview } from "@/components/features/employer/offers/offer-overview";
      ...
      {!showAllOffers && (
        ...
        >
          {[
            ...
            { label: "Declined", value: counts.Declined, icon: CircleCheck, swatch: "bg-destructive/10" },
            { label: "Expired", value: counts.Expired, icon: Clock, swatch: "bg-chart-2/20" },
          ].map((summary) => {
              ...
              <Card key={summary.label}>
                <CardContent className="flex items-center gap-3 p-5">
                  ...
                  <div>
                    ...
                    <p className="text-base font-semibold tracking-tight">{summary.label}</p>
                  </div>
                </CardContent>
              </Card>
            );
